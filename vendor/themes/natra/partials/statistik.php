...
<div class="box-body">
    ...
    <div class="box-stats d-flex justify-content-end">
        <div class="btn-group-xs">
            <a class="btn <?= ($tipe == 1) ? 'btn-primary' : 'btn-default' ?> btn-xs" onclick="switchType();">Bar
                Graph</a>
            <a class="btn <?= ($tipe == 0) ? 'btn-primary' : 'btn-default' ?> btn-xs" onclick="switchType();">Pie
                Cart</a>
        </div>
    </div>
</div>
                ...
                <?php foreach ($stat as $data): ?>
                    ...
                    if (1): ?>
                        ...
                        <tr class="<?= $hide ?>">
                            ...
                            <td><?= $data['nama'] ?></td>
                            <td class="angka <?php ($jm1 <= $jm - 2) and ($data['jumlah'] == 0) and print ('nol') ?>">
                                <?= $data['jumlah'] ?>
                            </td>
...
<?php if ($this->setting->daftar_penerima_bantuan && in_array($st, ['bantuan_keluarga', 'bantuan_penduduk'])): ?>
