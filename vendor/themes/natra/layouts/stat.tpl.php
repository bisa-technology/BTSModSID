				...
				<div class="content_bottom">
					<div class="col-lg-9 col-md-9">
						<div class="content_left">
							<?php switch ($tipe) {
								case 2:
									$this->load->view("$folder_themes/partials/statistik_sos");
									break;
								case 3:
									$this->load->view("$folder_themes/partials/wilayah");
									break;
								case 4:
									$this->load->view("$folder_themes/partials/dpt");
									break;
								default:
									$this->load->view("$folder_themes/partials/statistik");
									break;
							} ?>
						</div>
					</div>
