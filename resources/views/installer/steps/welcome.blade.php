...
<p class="pb-2 text-gray-800">
    Selamat datang di instalasi Website Desa.
</p>
...
<p class="pb-3 text-gray-800">
    Instalasi akan memasukkan informasi ini ke dalam file konfigurasi sehingga situs Anda dapat berkomunikasi dengan
    database Anda.
</p>
<p class="pb-4 text-gray-800">
    Butuh lebih banyak bantuan?
    <a class="text-blue-500 hover:underline" href="mailto:bisateknologisolution@gmail.com" target="_blank">Kontak
        Bantuan</a>.
</p>
<div class="flex justify-end">
    <a href="{{ site_url('install/server') }}"
