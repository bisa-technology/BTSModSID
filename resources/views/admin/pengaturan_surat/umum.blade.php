    ...
    <div class="box-body form-horizontal">
                ...
                <select class="form-control input-sm required" id="kode_surat" name="kode_surat"
                    ...
                    @if ($klasifikasiSurat)
                        <option value="{{ $klasifikasiSurat->kode }}">
                            {{ $klasifikasiSurat->kode . ' - ' . $klasifikasiSurat->nama }}
                        </option>
                    @elseif ($suratMaster->kode_surat)
                        <option value="{{ $suratMaster->kode_surat }}">
                            {{ $suratMaster->kode_surat }}
                        </option>
                    @endif
                </select>
            </div>
                    ...
                    <div class="col-sm-3">
                        <select class="form-control input-sm" id="satuan_masa_berlaku" name="satuan_masa_berlaku">
                            @foreach ($masaBerlaku as $kode_masa => $judul_masa)
                                <option value="{{ $kode_masa }}" @selected($suratMaster->satuan_masa_berlaku === $kode_masa)>
                                    {{ $judul_masa }}
                                </option>
                            @endforeach
                        </select>
        ...
        @if (isset($format_nomor))
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <input type="text" class="form-control input-sm" name="format_nomor" placeholder="Format Nomor Surat"
                        value="{{ $format_nomor }}">
                </div>
            </div>
        @endif
                ...
                <div class="btn-group col-xs-12 col-sm-8" data-toggle="buttons">
                    <label id="lq1"
                        ...
                        <input id="iq1" type="radio" name="qr_code" class="form-check-input" type="radio" value="1"
                            @checked($suratMaster->qr_code) autocomplete="off">Ya
                    </label>
                    <label id="lq2"
                        class="tipe btn btn-info btn-sm col-xs-12 col-sm-6 col-lg-3 form-check-label @active(!$suratMaster->qr_code)">
                        <input id="iq2" type="radio" name="qr_code" class="form-check-input" type="radio" value="0"
                            @checked(!$suratMaster->qr_code) autocomplete="off">Tidak
                    </label>
                </div>
            </div>
        @endif
            ...
            <div class="btn-group col-xs-12 col-sm-8" data-toggle="buttons">
                <label id="lbg1"
                    ...
                    <input id="ibg1" type="radio" name="logo_garuda" class="form-check-input" type="radio" value="1"
                        @checked($suratMaster->logo_garuda) autocomplete="off">Ya
                </label>
                <label id="lbg2"
                    class="tipe btn btn-info btn-sm col-xs-12 col-sm-6 col-lg-3 form-check-label @active(!$suratMaster->logo_garuda)">
                    <input id="ibg2" type="radio" name="logo_garuda" class="form-check-input" type="radio" value="0"
                        @checked(!$suratMaster->logo_garuda) autocomplete="off">Tidak
                </label>
            </div>
        </div>
                ...
                <div class="btn-group col-xs-12 col-sm-8" data-toggle="buttons">
                    <label id="lk1"
                        ...
                        <input id="ik1" type="radio" name="kecamatan" class="form-check-input" type="radio" value="1"
                            @checked($suratMaster->kecamatan) autocomplete="off">Ya
                    </label>
                    <label id="lk2"
                        class="tipe btn btn-info btn-sm col-xs-12 col-sm-6 col-lg-3 form-check-label @active(!$suratMaster->kecamatan)">
                        <input id="ik2" type="radio" name="kecamatan" class="form-check-input" type="radio" value="0"
                            @checked(!$suratMaster->kecamatan) autocomplete="off">Tidak
                    </label>
                </div>
            </div>
        @endif
            ...
            <div class="btn-group col-xs-12 col-sm-8" data-toggle="buttons">
                <label id="lm1"
                    ...
                    <input id="im1" type="radio" name="mandiri" class="form-check-input" type="radio" value="1"
                        @checked($suratMaster->mandiri) autocomplete="off">Ya
                </label>
                <label id="lm2"
                    class="tipe btn btn-info btn-sm col-xs-12 col-sm-6 col-lg-3 form-check-label @active(!$suratMaster->mandiri)">
                    <input id="im2" type="radio" name="mandiri" class="form-check-input" type="radio" value="0"
                        @checked(!$suratMaster->mandiri) autocomplete="off">Tidak
                </label>
            </div>
        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a class="btn-ok">
                    <a href="{{ route('surat_master.restore_surat_bawaan', $suratMaster->url_surat) }}"
