...
<div class="box box-info">
    <div class="box-header with-border">
                ...
                <ul class="dropdown-menu" role="menu">
                    ...
                    <li>
                        <a target="_blank" class="btn btn-social btn-block btn-sm aksi-terpilih"
                            title="Ekspor Surat TinyMCE"
                            onclick="formAction('mainform', '{{ route('surat_master.ekspor') }}'); return false;"><i
        ...
        @if (ENVIRONMENT === 'development')
            <a href="{{ route('surat_master.templateTinyMCE') }}" title="Buat Template TinyMCE"
                class="btn btn-social bg-blue btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"><i
                    class="fa fa-code-fork"></i> Buat Template TinyMCE</a></a>
        @endif
    </div>
