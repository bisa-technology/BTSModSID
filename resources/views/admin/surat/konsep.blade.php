    ...
    <div class="box-body">
        ...
        <div class="form-group">
            <textarea name="isi_surat"
                data-filemanager='<?= json_encode(['external_filemanager_path' => base_url('assets/kelola_file/'), 'filemanager_title' => 'Responsive Filemanager', 'filemanager_access_key' => $session->fm_key]) ?>'
                data-salintemplate="isi" class="form-control input-sm editor required">{{ $isi_surat }}</textarea>
        </div>
    </div>
    <div class="box-footer text-center">
        ...
        @if ($tolak != '-1')
            ...
            <a href="{{ route('keluar/clear/masuk') }}" id="next"
                class="btn btn-social btn-info btn-sm btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block hide">
...
@push('scripts')
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            const isCetak = path.search(/(\/surat\/cetak\/\d)/g);
